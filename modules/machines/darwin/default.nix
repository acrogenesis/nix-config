...
in {
  flake.darwinConfigurations = lib.listToAttrs (builtins.map (name:
    lib.nameValuePair name (self.inputs.nix-darwin.lib.darwinSystem {
      specialArgs = {
        inherit (self) inputs;
        self = { darwinModules = self.darwinModules; };
      };
      ...
      modules = [
        ...
        (self.inputs.nixpkgs.lib.attrsets.recursiveUpdate
          (homeManagerCfg true) {
