...
sudo systemctl stop 'immich*' \
  ...
  jellyfin.service sabnzbd.service sonarr.service radarr.service flaresolverr.service bazarr.service prowlarr.service seerr.service \
...
sudo systemctl start seerr.service jellyfin.service audiobookshelf.service
